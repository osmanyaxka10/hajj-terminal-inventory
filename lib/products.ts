...
export const PRODUCTS: Product[] = [
  {id:"fajita",name:"Chicken Fajita",category:"Sandwiches",shelfLifeDays:5,safetyStock:18,targetDays:1.5,active:true},
  {id:"tuna",name:"Tuna",category:"Sandwiches",shelfLifeDays:5,safetyStock:6,targetDays:1.5,active:true},
  {id:"halloumi",name:"Halloumi",category:"Sandwiches",shelfLifeDays:5,safetyStock:6,targetDays:1.5,active:true},
  {id:"turkey",name:"Turkey & Cheese",category:"Sandwiches",shelfLifeDays:5,safetyStock:6,targetDays:1.5,active:true},
...
export const ALIASES: Record<string,string> = {
  "fajita":"fajita","chicken fajita":"fajita",
